...
local Window = OrionLib:MakeWindow({Name = " 🌟 [FREE LIMITED] Race Clicker 🏆 | K'MAi", HidePremium = false, SaveConfig = true, ConfigFolder = "HACK" , IntroText = "MARRY HUB." , IntroIcon = "rbxassetid://12988752403"})


-- TAB บลาๆๆๆ 
local Auto = Window:MakeTab({ 
    Name = "ESP",
    Icon = "rbxassetid://8977565968",
    PremiumOnly = false
})

local Pet = Window:MakeTab({ --ธ
    Name = "PET",
    Icon = "rbxassetid://5172890314",
    PremiumOnly = false
})
-- END TAB

local Section = Auto:AddSection({
    Name = "(A new project 1.0 Game [FREE LIMITED] Race Clicker) \n(Credit : mai_m0000)"
})
